...
<template>
  <div class="h-full flex flex-col items-center justify-center px-6 relative overflow-hidden">
    ...
    <div class="relative z-10 flex flex-col items-center max-w-xs w-full text-center">
      ...
      <p class="text-sm text-zinc-400 mb-8">Choose a username for the leaderboard.</p>
      ...
      <form @submit.prevent="save" class="w-full space-y-3">
        ...
        <button
          ...
          class="w-full py-3.5 rounded-xl font-bold text-sm bg-emerald-500 hover:bg-emerald-400 text-white transition-all duration-100 active:scale-[0.98] disabled:opacity-60 shadow-lg shadow-emerald-500/20"
        >
